...
?>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 mt30 wow text-center">
                            <h2 class="section-heading"> Nouveau Contrat </h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section>
            <div class="section-inner">
                <div class="container">
                <div class="row">
                <form method="POST" action="assets/traitement/contrat_traitement.php">      
                            <b> Date Debut </b>
                            ...
                            <Select name ='idbox'> 
                                <?php 
                                    $sql= "SELECT * FROM box WHERE disponible ='oui'"; 
                                    $uncontrat = new contrat ('', '', '','','','','','','');
                                    $req = $uncontrat->affiche($sql,$con);
                                    foreach($req as $unbox) 
                                    {
                                ?>
                                    <option value ="<?php echo $unbox['idbox']?>"><?php echo $unbox['nombox']?> </option>
                                <?php 
                                    }
                                ?> 
                            </Select>
                            ...
                            <Select name ='idtp'> 
                                <?php 
                                    ...
                                    $uncontrat = new contrat ('', '', '','','','','','','');
                                    $req = $uncontrat->affiche($sql,$con);
                                    foreach($req as $untypepension) 
                                    {
                                ?>
                                    <option value ="<?php echo $untypepension['idtp']?>"><?php echo $untypepension['libtp']?> </option>
                                <?php 
                                    }
                                ?> 
                            </Select>
                            ...
                            <Select name ='idca'> 
                                <?php 
                                    ...
                                    $uncontrat = new contrat ('', '', '','','','','','','');
                                    $req = $uncontrat->affiche($sql,$con);
                                    foreach($req as $uncavalier) 
                                    {
                                ?>
                                    <option value ="<?php echo $uncavalier['idca']?>"><?php echo $uncavalier['preca']?> &nbsp <?php echo $uncavalier['nomca']?> </option>
                                <?php 
                                    }
                                ?> 
                            </Select>
                            ...
                            <Select name ='idche'> 
                                <?php 
                                    ...
                                    {
                                ?>
                                    <option value ="<?php echo $uncheval['idche']?>"><?php echo $uncheval['nomche']?> </option>
                                <?php 
                                    }
                                ?> 
                            </Select>
