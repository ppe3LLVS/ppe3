<?php
    ...
    include ("assets/class/contrat.class.inc.php");
    $sql = 'SELECT idcon, ddcon, dfcon, tarifcon, nombox, libtp, nomca, preca, nomche FROM contrat left join box on box.idbox = contrat.idbox left join typepension on typepension.idtp = contrat.idtp left join cavalier on cavalier.idca = contrat.idca left join chevaux on chevaux.idche = contrat.idche WHERE valide="Oui"';
    $uncontrat = new contrat ('', '', '','','','','','','');
    $req = $uncontrat->affiche($sql,$con);
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 mt30 wow text-center">
                            <h2 class="section-heading"> Contrat </h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="section-inner">
                ...
                <center> <table border = 5px>
                    <tr> 
                        ...
                        <th> Type Pension </th>
                        <th> Nom Cavalier </th> 
                        <th> Prenom Cavalier </th>
                        <th> Cheval</a> </th>
                        <th> Action </th> 
                    </tr> 

                <?php 
                    foreach($req as $uncontrat) 
                    {
                ?>  
                    <tr>
                        <td> <?php echo $uncontrat['idcon'];?> </td>
                        <td> <?php echo $uncontrat['ddcon'];?> </td>
                        <td> <?php echo $uncontrat['dfcon'];?> </td> 
                        <td> <?php echo $uncontrat['tarifcon'];?></td> 
                        <td> <?php echo $uncontrat['nombox'];?></td> 
                        <td> <?php echo $uncontrat['libtp'];?></td>   
                        <td> <?php echo $uncontrat['nomca'];?></td> 
                        <td> <?php echo $uncontrat['preca'];?></td>
                        <td> <?php echo $uncontrat['nomche'];?></td>
                        <td> <a href ="assets/traitement/contrat_traitement.php?supprimer=<?php echo $uncontrat ['idcon'];?>"> Supprimer </a> </td>
                    </tr>
                <?php 
                    }  
                ?> 
