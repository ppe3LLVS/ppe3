...
<head>
    ...
    <link rel="shortcut icon" href="assets/img/ico/favicon4.png">
    ...
    <script type="text/javascript" src="assetsjs/script.js"></script>
    ...
    <div class="master-wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top fadeInDown" data-wow-delay="0.5s">
            ...
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand smoothie logo logo-light" href="index.html"><img src="assets/img/logo3.png" alt="logo"></a>
                    <a class="navbar-brand smoothie logo logo-dark" href="index.html"><img src="assets/img/logo3.png" alt="logo"></a>
                </div>
                ...
                <div class="collapse navbar-collapse col-sm-12 text-center" id="main-navigation">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="index.html" class="dropdown-toggle" data-toggle="dropdown">Accueil</a>
                        </li>
                        <li class="dropdown">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="type_pension.php">Type pension</a></li>
                                <li><a href="box.php">Box</a></li>
                                <li><a href="contrat.php">Demande de contrat</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Promenades</a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown">
        ...
        <section>
            <div class="section-inner">
                ...
                <div class="row"> 
                    <a> Type contrat  </a> 
                        <form name="validation" method="POST" action="cat_delete.php">
                            <Select name ='idcat'> 
                            <?php 
                                foreach($req as $unepension) 
                            {
                            ?>
                            <option value ="<?php echo $unepension['idtp']?>"><?php echo $unepension['libtp']?> </option>
                            <?php 
                            }
                            ?>
                            <br> <br>
                            <a> Date : </a> <input type="date" id="datepicker"> 
