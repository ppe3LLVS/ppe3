                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 mt30 wow text-center">
                            <h2 class="section-heading"> Nouveau Box </h2>
                        </div>
                    </div>
                </div>
            </div>
...
<section>
            <div class="section-inner">
                <div class="container">
                <div class="row">
                    <form method = "POST" action ="assets/traitement/box_traitement"> 
                        <b> Nom du Box : <input type = "text" name ="nombox"> </b> 
                        <br> <br> 
                        <input type ="submit" name ="new_box" value="Envoyer"> 
                    </form>
