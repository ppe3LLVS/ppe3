                        ...
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="0.2s">
                            <div class="icon-box-1 match-height mb30">
                                ...
                                <div class="content-area">
                                    <h3 class="title">Demi pension</h3>
                                    <div class="content"> Tarif : 170€</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="0.2s">
                            <div class="icon-box-1 match-height mb30">
                                <i class="# "><img src="assets/img/ico/favicon4.png" alt="logo"> </i>
                                <div class="content-area">
                                    <h3 class="title">Pension complète</h3>
                                    <div class="content">Tarif : 340€ </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="0.2s">
                            <div class="icon-box-1 match-height mb30">
                                ...
                                <div class="content-area">
                                    <h3 class="title">Propriètaire</h3>
