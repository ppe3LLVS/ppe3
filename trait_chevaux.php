                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    //quand le bouton ajouter est utilisé
									if(isset($_POST['ajouterchev']))
									{
										$nch = $_POST['nomche'];
										$dnch = $_POST['dnche'];
										$tch = $_POST['tailleche'];
										$orace = $_POST['race2'];
										$orobe = $_POST['robe2'];
                                        //débug pour être sur qu'il ne rentre pas de valeur null
										if($nch == null AND $dnch == null AND $tch == null)
										{
											echo "vous n'avez pas rentré toutes les valeurs";
									    }
                                        //débug qui vérifie si toutes valeurs sont rentrée 
									   if (isset($nch)  AND isset($dnch) AND isset($tch))
									   {
                                        $SQL=" INSERT INTO chevaux VALUES (null, '$nch', '$dnch', $tch, $orace, $orobe)";
                                        $req = $con -> query($SQL);
									   }
										
									}

                                    //quand le bouton supprimer est utilisé
                                    if(isset($_GET['sup'])) 
                                    {
                                       $idche = $_GET['sup'];
                                        $oche = new chevaux('','','','','','');
                                        $req = $oche->supprimerche($con, $idche);
                                        echo "le cheval a bien été supprimer ";
                                    }


                                	?>
								<h4>vous pouvez cliquer sur ce bouton ou revenir en arrière</h4>
...
<body>
	...
	<a href="tous_chevaux_ad.php" class="card blue">
		<h2>retour</h2>
